/****************************************************************************
** Meta object code from reading C++ file 'user_player.h'
**
...
#error "The header file 'user_player.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UserPlayer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 56, 8)
    ...
    "UserPlayer\0doTurn\0\0BasePlayer*\0player\0"
    "sendTurn\0Position\0decision"
};
...
void UserPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UserPlayer *_t = static_cast<UserPlayer *>(_o);
        switch (_id) {
        case 0: _t->doTurn((*reinterpret_cast< BasePlayer*(*)>(_a[1]))); break;
        case 1: _t->sendTurn((*reinterpret_cast< Position(*)>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject UserPlayer::staticMetaObject = {
    { &BasePlayer::staticMetaObject, qt_meta_stringdata_UserPlayer.data,
      qt_meta_data_UserPlayer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UserPlayer.stringdata))
        return static_cast<void*>(const_cast< UserPlayer*>(this));
